...
* You will need to have an SQLite driver installed (e.g., I use one from Actual Technologies).
* Once you've installed the driver, change the Driver file path below to point to it.
* Leave the other settings in the conncection string as they are.
