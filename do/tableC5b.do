...
************* Display Table 5. *************
********************************************
local title "\autoref{table5}, papers with 50\% or more female authors"
#delimit ;
local note "
	...
	to 1 if the paper is authored by at least 50\% women (\(\beta_1\)); female-authored (men): analogous effect for male authors
...
";
#delimit cr
estout est_Fem50_* using "`tex_path'/tableC5b.tex", style(publishing-female_latex) ///
