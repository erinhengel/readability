...
************* Display Table 5. *************
********************************************
local title "\autoref{table5}, papers with 100\% female authors"
#delimit ;
local note "
	...
	to 1 if the paper is authored entirely by women (\(\beta_1\)); female-authored (men): analogous effect for male authors
...
";
#delimit cr
estout est_Fem100_* using "`tex_path'/tableC5c.tex", style(publishing-female_latex) ///
