...
************* Display Table 4. *************
********************************************
local title "\autoref{table4}, 100\% female-authored papers"
...
local note "
	...
	for papers entirely female authored and 0 for papers entirely male authored. Papers with both male and female co-authors
	are excluded. Quality controls denoted by \(\text{\ding{51}}^1\) include citation
	count and \(\text{max. }T_j\) fixed effects. Standard errors clustered on editor in parentheses.
";
#delimit cr
estout est_*_Editor using "`tex_path'/tableC4a.tex", style(publishing-female_latex) ///
