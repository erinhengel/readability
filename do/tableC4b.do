...
************* Display Table 4. *************
********************************************
local title "\autoref{table4}, papers with at least one female author"
...
local note "
	...
	for papers with at least one female author. Quality controls denoted by \(\text{\ding{51}}^1\) include citation
	count and \(\text{max. }T_j\) fixed effects. Standard errors clustered on editor in parentheses.
";
#delimit cr
estout est_*_Editor using "`tex_path'/tableC4b.tex", style(publishing-female_latex) ///
