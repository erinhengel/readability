...
";
#delimit cr
estout reg_*alt su_*alt fe_alt using "`tex_path'/table7ALTERNATIVE.tex", style(publishing-female_latex) ///
...
latextable, ///
	...
	note(`"`note'"')
noisily estout_display reg_*alt su_*alt fe_alt, style(publishing-female_smcl) ///
	stats(editor journal year jnlyr qual native, labels("Editor effects" "Journal effects" "Year effects" ///
		"Journal#Year effects" "Quality controls" "Native speaker")) ///
	title("Table 8: `title'") ///
